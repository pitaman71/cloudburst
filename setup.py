...
setup(
    ...
    # Author details
    author='Alan Pita',
    author_email='alan.pita@experoinc.com',
    ...
    keywords='cloud application framework',
    ...
    install_requires=['argparse','code','copy','functools','glob',
        'inspect','json','os','pexpect','re','socket','subprocess','sys','shutil',
        'task','tempfile','threading','time','traceback''urllib','uuid','xml'],
